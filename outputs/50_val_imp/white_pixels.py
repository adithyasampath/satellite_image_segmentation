...
# for windows
PROJECT_PATH = r"C:\Users\adsampat\Documents\Python_Scripts\My GitHub\unet\unet\50_val_imp"
...
# images = load_images(os.path.join(PROJECT_PATH, path_1))
# for image_file, image in images:
#     print(image_file)
#     cv2.imwrite(PROJECT_PATH + "/lr/" + image_file, image)
